...
<table border="1" style="font-size: 10pt;" width="100%">
    ...
    <tr>
        <td style="text-align: center;" colspan="7">
            <b>REPORTE DE TOTALES DE PLANILLA <?php echo $anoEje; ?> - <?php echo $mesEje->getNombre(); ?><br>
                <?php echo $especifica->getNombre(); ?><br>
                <?php echo $especifica->getEspecifica(); ?>
            </b>
        </td>
    </tr>
    <tr>
...
$dompdf->render();
$dompdf->stream("resumenTE".$fechadoc.".pdf", array("Attachment" => 0));
?>
