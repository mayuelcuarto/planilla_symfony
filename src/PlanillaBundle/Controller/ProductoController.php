...
class ProductoController extends Controller
{
    ...
    public function indexAction(Request $request){
        ...
        $productos = $producto_repo->findBy(array(), array('estado' => 'DESC','id' => 'ASC'));
        
        return $this->render("@Planilla/producto/index.html.twig", array(
            "productos" => $productos
        ));
    }
    ...
    public function addAction(Request $request){
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                $em = $this->getDoctrine()->getManager();
                $producto_repo = $em->getRepository("PlanillaBundle:Producto");
                $producto = $producto_repo->findOneBy(array(
        ...
        return $this->render('@Planilla/producto/add.html.twig',
                array(
    ...
    public function editAction(Request $request, $id){
        ...
        return $this->render('@Planilla/producto/edit.html.twig',
                array(
                    "form" => $form->createView()
                )
                );
