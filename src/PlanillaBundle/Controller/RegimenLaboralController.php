...
class RegimenLaboralController extends Controller
{
    ...
    public function indexAction(Request $request){
        ...
        $regimenLaborals = $regimenLaboral_repo->findBy(array(), array('estado' => 'DESC','id' => 'ASC'));
        
        return $this->render("@Planilla/regimenLaboral/index.html.twig", array(
            "regimenLaborals" => $regimenLaborals
        ));
    }
    ...
    public function addAction(Request $request){
        ...
        $sth1 = $em->getConnection()
                    ->prepare("SELECT SugerirRegimenLaboral()");
        $sth1->execute();
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                $regimenLaboral_repo = $em->getRepository("PlanillaBundle:RegimenLaboral");
                $regimenLaboral = $regimenLaboral_repo->findOneBy(array(
                ...
                if($regimenLaboral != null){
                    ...
                    $sth = $em
                            ->getConnection()
                            ->prepare("CALL AgregarRegimenLaboral(:id, :nombre, :descripcion, :estado)");
        ...
        return $this->render('@Planilla/regimenLaboral/add.html.twig',
                array(
    ...
    public function editAction(Request $request, $id){
        ...
        return $this->render('@Planilla/regimenLaboral/edit.html.twig',
                array(
                    "form" => $form->createView()
                )
                );
