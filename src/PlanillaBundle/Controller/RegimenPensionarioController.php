...
class RegimenPensionarioController extends Controller
{
    ...
    public function indexAction(Request $request){
        ...
        $regimenPensionarios = $regimenPensionario_repo->findBy(array(), array('estado' => 'DESC','id' => 'ASC'));
        
        return $this->render("@Planilla/regimenPensionario/index.html.twig", array(
            "regimenPensionarios" => $regimenPensionarios
        ));
    }
    ...
    public function addAction(Request $request){
        ...
        $sth1 = $em->getConnection()
                    ->prepare("SELECT SugerirRegimenPensionario()");
        $sth1->execute();
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                $regimenPensionario_repo = $em->getRepository("PlanillaBundle:RegimenPensionario");
                $regimenPensionario = $regimenPensionario_repo->findOneBy(array(
                ...
                if($regimenPensionario != null){
                    ...
                    $sth = $em
                            ->getConnection()
                            ->prepare("CALL AgregarRegimenPensionario(:id, :nombre, :estado)");
        ...
        return $this->render('@Planilla/regimenPensionario/add.html.twig',
                array(
    ...
    public function editAction(Request $request, $id){
        ...
        return $this->render('@Planilla/regimenPensionario/edit.html.twig',
                array(
                    "form" => $form->createView()
                )
                );
