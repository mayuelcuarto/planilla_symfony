...
class TipoConceptoController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        $tipoConceptos = $tipoConcepto_repo->findBy([], ['estado' => 'DESC', 'id' => 'ASC']);

        return $this->render("@Planilla/tipoConcepto/index.html.twig", ["tipoConceptos" => $tipoConceptos]);
    }
    ...
    public function addAction(Request $request) {
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                $em = $this->getDoctrine()->getManager();
                $tipoConcepto_repo = $em->getRepository("PlanillaBundle:TipoConcepto");
                $tipoConcepto = $tipoConcepto_repo->findOneBy(["nombre" => $form->get("nombre")->getData()]);
        ...
        return $this->render('@Planilla/tipoConcepto/add.html.twig', ["form" => $form->createView()]);
    }
    ...
    public function editAction(Request $request, $id) {
        ...
        return $this->render('@Planilla/tipoConcepto/edit.html.twig', ["form" => $form->createView()]);
    }
