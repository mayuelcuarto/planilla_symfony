...
class SituacionLaboralController extends Controller
{
    ...
    public function indexAction(Request $request){
        ...
        $situacionLaborals = $situacionLaboral_repo->findBy(array(), array('estado' => 'DESC','id' => 'ASC'));
        
        return $this->render("@Planilla/situacionLaboral/index.html.twig", array(
            "situacionLaborals" => $situacionLaborals
        ));
    }
    ...
    public function addAction(Request $request){
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                $em = $this->getDoctrine()->getManager();
                $situacionLaboral_repo = $em->getRepository("PlanillaBundle:SituacionLaboral");
                $situacionLaboral = $situacionLaboral_repo->findOneBy(array(
        ...
        return $this->render('@Planilla/situacionLaboral/add.html.twig',
                array(
    ...
    public function editAction(Request $request, $id){
        ...
        return $this->render('@Planilla/situacionLaboral/edit.html.twig',
                array(
                    "form" => $form->createView()
                )
                );
