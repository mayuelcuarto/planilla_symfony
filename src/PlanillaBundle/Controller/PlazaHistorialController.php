...
class PlazaHistorialController extends Controller
{
    ...
    public function indexAction(Request $request, $id){
        ...
        $plazaHistorials = $plazaHistorial_repo->findBy(array('plaza' => $id), array('estado' => 'DESC'));
        $plazaHistorialOn = $plazaHistorial_repo->findBy(array('plaza' => $id, 'estado'=> true));
        ...
        return $this->render("@Planilla/plazaHistorial/index.html.twig", array(
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                    ...
                    $sth1 = $em->getConnection()
                            ->prepare("SELECT GenerarSecPlazaHistorial(:plazaId)");
            ...
            return $this->redirectToRoute("plazaHistorial_index",array("id" => $plazaId));
        }
